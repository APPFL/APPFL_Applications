...
def get_model(comm: MPI.Comm):
    ...
    model = TransformerModel(emsize, nhead, dim_feedforward, nlayers, n_conv_layers, n_class, dropout, dropout_other)
...
# mpiexec -np 6 --mca opal_cuda_support 1 python ./appl_ecg_transformer.py --num_epochs 25 --client_lr 1e-4
